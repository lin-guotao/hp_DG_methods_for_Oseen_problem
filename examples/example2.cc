...
namespace example2
{
  ...
  {
  public:
    OseenProblem(const MeshType mesh_type = MeshType::Mesh2,
                 const FEType   fe_type   = FEType::hp_type,
                 const double   Re        = 1.0);
  ...
  private:
    ...
    const std::string example_name = "example2";
...
main()
{
  try
    {
      using namespace dealii;
      using example2::FEType;
      using example2::MeshType;

      for (const FEType fe_type : {FEType::P1P1,
                                   FEType::P2P1,
                                   FEType::P2P2,
                                   FEType::P3P2,
                                   FEType::hp_type})
        {
          example2::OseenProblem<2> oseen_problem(MeshType::Mesh2,
                                                  fe_type,
                                                  /*Re =*/1.0);
          oseen_problem.run();
        }
